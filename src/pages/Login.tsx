...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-md rounded-2xl bg-card p-8 shadow-card animate-fade-in">
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          ...
          <Link to="/signup" className="font-medium text-primary-dark hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
